...
// AlertDialog components (using Dialog as base)
...
function AlertDialogAction({
  ...
  return (
    <DialogPrimitive.Close
      className={cn(
        "inline-flex justify-center items-center bg-primary hover:bg-primary/90 disabled:opacity-50 px-4 py-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ring-offset-background focus-visible:ring-offset-2 h-10 font-semibold text-primary-foreground text-sm transition-colors disabled:pointer-events-none",
        className
      )}
      {...props}
    />
...
function AlertDialogCancel({
  ...
  return (
    <DialogPrimitive.Close
      className={cn(
        "inline-flex justify-center items-center bg-background hover:bg-accent disabled:opacity-50 px-4 py-2 border border-input rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ring-offset-background focus-visible:ring-offset-2 h-10 font-semibold text-sm transition-colors hover:text-accent-foreground disabled:pointer-events-none",
        className
      )}
      {...props}
    />
