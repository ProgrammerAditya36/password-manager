...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "group relative flex items-center aria-selected:bg-accent data-[disabled]:opacity-50 px-2 py-1.5 rounded-sm outline-none text-sm aria-selected:text-accent-foreground cursor-default data-[disabled]:pointer-events-none select-none",
      className
    )}
    {...props}
  />
